    ...
    <div>
        ...
        <el-dialog v-model="addDialogVisible" title="添加角色">
            <el-form ref="addFormRef" :model="addForm" :rules="rules" label-width="80px" class="ruleForm" status-icon>
                ...
                <el-form-item label="角色权限" prop="rights">
                    <el-tree :data="rightlist" :props="defaultProps" show-checkbox node-key="path" ref="addTreeRef" :check-strictly="true"/>
                </el-form-item>
            </el-form>
    ...
    addFormRef.value.validate(async (valid) => {
        if (valid) {
            ...
            await axios.post(`/adminapi/roles`, {
                ...
                rights: JSON.stringify(addTreeRef.value.getCheckedKeys())
            })
            await getList()
            addForm.roleName = ""
